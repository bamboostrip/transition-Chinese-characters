...
{
    EcodingChoice = CP1252
}
FileEncoding, %EcodingChoice%


FileRead, text, %file%
StringLower, text, text ; 将文本转换为小写
StringReplace, text, text, `,, %A_Space%`,, All ; 在逗号前添加空格
StringReplace, text, text, ., %A_Space%., All ; 在句点前添加空格
StringReplace, text, text, !, %A_Space%!, All ; 在感叹号前添加空格
StringReplace, text, text, `?, %A_Space%`?, All ; 在问号前添加空格
